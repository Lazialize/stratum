...
- [x] 4. PostgreSQL型変更SQL生成の実装
- [x] 4.1 (P) PostgreSQL用のALTER COLUMN TYPE文を生成する
...
- [x] 5. MySQL型変更SQL生成の実装
- [x] 5.1 (P) MySQL用のMODIFY COLUMN文を生成する
...
- [x] 6. SQLiteテーブル再作成の実装
- [x] 6.1 SQLiteテーブル再作成サービスを実装する
